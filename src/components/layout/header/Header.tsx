    ...
    return (
        <>
            <header className="header">
                ...
                <button className={`header__burger ${isMenuOpen ? 'open' : ''}`} aria-label="open menu" onClick={toggleMenu} type="button">
                ...
                <nav className="header__nav-desktop">
                    <ul className="header__nav-list">
                        ...
                        <li>
                            <Link className="header__nav-link" to="/stats/current">Stats</Link>
                        </li>
                    </ul>
                </nav>
                {isMenuOpen && (
                    <div className="header__overlay">
                        <nav className="header__overlay-nav">
                            <ul className="header__overlay-list">
                                ...
                                <li className="header__overlay-item">
                                    <Link className="header__overlay-link" to="/stats/current" onClick={toggleMenu}>
                                        Stats
                                    </Link>
                                </li>
                                <li className="header__overlay-item">
